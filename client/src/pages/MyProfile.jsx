...
const MyProfile = () => {
    const [userData, setUserData] = useState({
        ...
        phone : '+91 9773169882',
        address : {
            line1 : "9/99, nilam park, bhaktinagar",
            line2 : "Bapunagar, Ahmedabad"
        }, 
        gender : 'Male',
        dob : '2004-11-22'
    });
                ...
                <div className="grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700">
                    ...
                    <p className="font-medium">Address:</p>
                    {
                        ...
                        <p>
                            ...
                            <br/>
                            <input className="bg-gray-50" type='text' onChange={(e) => setUserData(perv => ({...prev, address : {...prev.address, line2: e.target.value}}))}/>
                        </p>
                        :
