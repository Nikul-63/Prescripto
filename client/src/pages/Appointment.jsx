    ...
    const getAvailableSlots = async () => {
        ...
        for (let i = 0; i < 7; i++) {
            ...
            while (currentDate < endTime) {
                ...
                const bookedSlotsForData = docInfo.slots_booked?.[slotDate] || [];
                const isSlotAvailable = !bookedSlotsForData.includes(slotTime);
    ...
    return docInfo && (
        <div>
            ...
            <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
                ...
                <button onClick={bookAppointment} className='bg-primary text-white text-sm font-light px-14 py-3 rounded-full mt-4'>
                    Book an appointment
                </button>
            </div>
